...
CREATE TABLE Article(
	...
	producer_id INTEGER FOREIGN KEY REFERENCES Producer ON DELETE SET NULL
);
...
CREATE TABLE Sale(
	...
	tax INTEGER,
	customer_id INTEGER FOREIGN KEY REFERENCES Customer ON DELETE SET NULL
);

CREATE TABLE SpecificArticle(
	id INTEGER PRIMARY KEY,
	sale_id INTEGER FOREIGN KEY REFERENCES Sale ON DELETE SET NULL,
	price DECIMAL(5,2),
	article_id VARCHAR(20) FOREIGN KEY REFERENCES Article ON DELETE SET NULL
);
